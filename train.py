...
class DrugDataset(utils.Dataset):
    ...
    # Rewrite load_shapes, which contains your own category
    # And added path, mask_path, yaml_path in self.image_info information
...
#        self.add_class("shapes", 1, "Rectangle") 
        ...
        self.add_class("shapes", 1, "cut")
        self.add_class("shapes", 2, "outChar")
        self.add_class("shapes", 3, "effect")
        self.add_class("shapes", 4, "bubble")
        self.add_class("shapes", 5, "character")
    ...
    def load_mask(self, image_id):
        ...
        for i in range(len(labels)):
            if labels[i].find("cut") != -1:
                labels_form.append("cut")
            elif labels[i].find("outChar") != -1:
                labels_form.append("outChar")
            elif labels[i].find("effect") != -1:
                labels_form.append("effect")
            elif labels[i].find("bubble") != -1:
                labels_form.append("bubble")
            elif labels[i].find("character") != -1:
                labels_form.append("character")
